...
bridge = "Stop! Who would cross the Bridge of Death must answer me these questions three, " \
...
while choice != "quit":
    ...
    choice = input("You can choose to go into the 'forest', head back to 'camelot', go make"
                   "some 'rabbit' stew, try to recruit the 'french' to join your quest, or celebrate at a 'wedding'."
                   "If you get tired, you can just 'quit' and go home.")
    if choice.lower() == "forest":
        print(
            "As you traverse this dense forest, you are stopped by the Knights of Ni. You appease the Knights of Ni by "
            "spending your money on shrubberies courtesy of Roger the Shrubber. At least you didn't need to chop down "
            "the largest tree in the forest with a herring.")
        print("")
    elif choice.lower() == "camelot":
        print(
            "You've done it. You've reached Camelot. This great castle (while it's only a model), is the most "
